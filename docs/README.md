...
Durable project documentation. Session notes and raw artifacts live under
`ephemeral/`, never here.
...
- Working notes kept for reference: [internal-dev-notes.md](internal-dev-notes.md),
  ...
  [tutorial.mdx](tutorial.mdx).

Agent operating instructions are in the root `AGENTS.md` (`CLAUDE.md` is a
symlink to it).
